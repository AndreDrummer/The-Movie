...
class Endpoints {
  ...
  static String popularMovieList() {
    return 'https://api.themoviedb.org/3/movie/popular?api_key=${Constantes.api}';
  }
  ...
  static String movieDetail(int movieID, {String language = 'pt-BR'}) {
    return 'https://api.themoviedb.org/3/movie/$movieID?api_key=${Constantes.api}&language=$language&append_to_response=credits';
  }

  static String movieListByGenre(int genreID, {String language = 'pt-BR', int page = 1}) {
    return 'https://api.themoviedb.org/3/discover/movie?api_key=${Constantes.api}&with_genres=$genreID&language=$language&page=$page';
  }
}
